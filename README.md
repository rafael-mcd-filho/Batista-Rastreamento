...
HELENA_CHAT_API_BASE_URL=https://api.helena.run/chat/v1
HELENA_MESSAGE_FROM=5583988098480
HELENA_TEMPLATE_ID=9be1f_faturadiadovencimento
HELENA_RENOVACAO_TEMPLATE_ID=27cb8_renovacao
...
HELENA_API_TOKEN
HELENA_API_BASE_URL
HELENA_CHAT_API_BASE_URL
HELENA_MESSAGE_FROM
HELENA_TEMPLATE_ID
HELENA_RENOVACAO_TEMPLATE_ID
